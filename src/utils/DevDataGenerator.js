...
export const generateFakeData = () => {
    ...
    // 5. Update LocalStorage (Sales and History) - REMOVED FOR CLEAN CLOUD SYNC
    ...
    // Initial inventory stock - REMOVED
    // ...
    const sortedSales = sales.sort((a, b) => new Date(b.closedAt) - new Date(a.closedAt));
    const mockInventory = {};
    BEERS.forEach(beer => {
    ...
    // 6. INSTANT REACTIVE REFRESH (Memory Only for Session Mocking if needed)
    ...
    console.log("¡Data inyectada en MEMORIA con éxito! (No se guardó en local)");
};
...
export const clearAllData = () => {
    ...
    localStorage.clear(); // Ensure everything is gone as requested
