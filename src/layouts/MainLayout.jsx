...
export default function MainLayout() {
    ...
    const navItems = [
        ...
        // Only show 'Caja' to OWNER, MANAGER, DEVELOPER (not EMPLOYEE)
        ...(role && ['OWNER', 'MANAGER', 'DEVELOPER'].includes(role) ? [{ path: '/caja', label: 'Caja', icon: Receipt }] : []),
    ...
    // Listener para modales abiertos/cerrados
    React.useEffect(() => {
    ...
    return (
        <div ref={containerRef} className="layout-container">
            <nav className={`main-nav ${isCompact ? 'compact-wrapper' : ''} ${isModalOpen ? 'hide-nav-desktop' : ''}`}>
